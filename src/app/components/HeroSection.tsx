...
export default function HeroSection() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative h-[250vh] bg-[#05051a] text-white flex flex-col w-full"
    >
      <div className="sticky top-0 h-screen w-full flex flex-col overflow-hidden">
        {/* Background Animation - Slowed Down */}
        ...
        <div className="relative z-10 flex flex-1 items-center justify-center w-full h-full overflow-hidden pb-10">
          ...
          >
            {/* Elegant Search Box */}
            <div className="inline-flex items-center gap-3 bg-white/[0.04] border border-white/10 rounded-full px-5 py-2.5 text-xs text-white/50 mb-10 w-[350px] focus-within:border-blue-500/60 focus-within:bg-white/[0.08] transition-all backdrop-blur-sm group shadow-inner">
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
                ...
                className="text-white/30 group-focus-within:text-blue-400 transition-colors"
              >
              ...
              <input
                ...
                className="bg-transparent border-none outline-none text-left w-full placeholder:text-white/20 font-light tracking-wide"
              />
            </div>
