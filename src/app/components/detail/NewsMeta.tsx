  ...
  return (
    <div className="flex flex-wrap items-center gap-6 py-6 border-y border-gray-200 dark:border-white/[0.06] mb-10 transition-colors duration-500">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center text-blue-600 dark:text-blue-400 font-bold text-sm transition-colors">
          {news.author?.charAt(0) || "A"}
        </div>
        <div>
          <p className="text-[11px] text-gray-500 dark:text-white/40 uppercase tracking-widest font-bold mb-0.5 transition-colors">Penulis</p>
          <p className="text-sm font-bold text-gray-900 dark:text-white/90 transition-colors">{news.author || "Anonim"}</p>
        </div>
      </div>
