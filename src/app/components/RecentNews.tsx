...
const data: News[] = [
  {
    ...
    description: "Revolusi kecerdasan buatan mendominasi efisiensi operasional industri.",
  ...
  },
  {
    ...
    description: "Pasar menunjukkan tren volatilitas tinggi akibat pergeseran kebijakan.",
  ...
  },
  {
    ...
    description: "Komputasi kuantum menjanjikan keamanan data bagi sektor perbankan.",
  ...
  },
  {
    ...
    description: "Ekosistem teknologi bergairah dengan suntikan dana triliunan rupiah.",
            ...
            {extended.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`relative shrink-0 rounded-[28px] overflow-hidden cursor-pointer shadow-[0_20px_50px_rgba(0,0,0,0.5)] bg-[#0d0d14] border ${isCenter ? "border-white/20" : "border-white/5"}`}
                  style={{
                    width: CARD_WIDTH,
                    marginRight: GAP,
                    height: 260,
                ...
                >
                  ...
                  >
                    <span
                      className={`self-start text-[9px] uppercase tracking-[0.2em] font-extrabold px-3 py-1.5 rounded-lg border transition-colors duration-300 ${
      ...
      <AnimatePresence>
        {active && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-8">
            ...
            <motion.div
              className="relative w-full max-w-2xl bg-white/[0.03] border border-white/10 rounded-[40px] overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.5)] backdrop-blur-3xl"
            ...
            >
              <div className="p-10 md:p-14 flex flex-col justify-center relative">
                  <div className="flex gap-3 mb-8">
                    ...
                    <span className="px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest bg-white/5 border border-white/10 text-white/40">
                      Insight AI
                    </span>
                  </div>
                  ...
                  >
                    ...
                    <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/5">
                      ...
                      <p className="text-white/40 text-xs leading-relaxed font-light">
                        ...
                        <span className="text-white/80 font-medium">15-20%</span>{" "}
